import { j as jsxRuntimeExports, r as reactExports, d as addWidgetBreadcrumb, b as captureWidgetException } from "./adapter-CWih0Dk2.js";
import { B as Button } from "./Button-B-UKYG31.js";
import { c as clientExports, S as SET_GLOBALS_EVENT_TYPE } from "./types-Du1vURRP.js";
import { S as Search } from "./Search-BjVbs7rE.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 self-start sm:self-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-tertiary", children: [
...
function SearchResultCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      tabIndex: 0,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-4 top-4 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchScoreBadge, { score: resource.qualityScore, variant: "card" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
            ...
            featured && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] uppercase tracking-[0.16em] text-[#ff9a52]", children: "Lead result" })
          ] }),
...
function MarketplaceSearch() {
  ...
  const handleSearchSubmit = reactExports.useCallback(async () => {
    ...
    try {
      ...
      const response = await callTool("x402_search", {
        query: nextQuery,
        category: typeof toolInput?.category === "string" ? toolInput.category : void 0,
        network: typeof toolInput?.network === "string" ? toolInput.network : void 0,
        maxPriceUsdc: typeof toolInput?.maxPriceUsdc === "number" ? toolInput.maxPriceUsdc : void 0,
        verifiedOnly: typeof toolInput?.verifiedOnly === "boolean" ? toolInput.verifiedOnly : void 0,
        sort: typeof toolInput?.sort === "string" ? toolInput.sort : void 0,
  ...
  if (activeOutput.count === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-theme": theme, className: "p-4", style: { maxHeight: maxHeight ?? void 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(EmptyMessage, { className: "rounded-2xl border border-subtle bg-surface px-4 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyMessage.Icon, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(EmptyMessage.Title, { children: [
        "No x402 APIs found",
        externalQuery ? ` for "${externalQuery}"` : ""
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyMessage.Description, { children: "Try a broader query or a different provider/category angle." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
