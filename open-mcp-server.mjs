...
const SEARCH_META = widgetMeta('ui://dexter/x402-marketplace-search-v5', 'Searching marketplace…', 'Results ready', 'Shows paid API search results as interactive cards with quality rings, prices, and fetch buttons.');
...
function createOpenMcpServer() {
  ...
  try {
    registerAppsSdkResources(server, {
      allowedTemplateUris: [
        'ui://dexter/x402-marketplace-search-v5',
